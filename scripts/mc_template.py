...
SWIFT_MENUBAR_SOURCE = r'''import Cocoa
import Foundation
...
class MenuBarAppDelegate: NSObject, NSApplicationDelegate {
    ...
    func refreshMenu() {
        ...
        let hiddenItem = NSMenuItem(title: "Gizli Dosyaları Göster (.dotfiles)", action: #selector(toggleHiddenFiles), keyEquivalent: "h")
        ...
        let extItem = NSMenuItem(title: "Tüm Dosya Uzantılarını Göster (.json, .env)", action: #selector(toggleExtensions), keyEquivalent: "e")
        extItem.target = self
        ...
        let desktopItem = NSMenuItem(title: "Masaüstü Simgelerini Göster", action: #selector(toggleDesktopIcons), keyEquivalent: "d")
        ...
        let dockItem = NSMenuItem(title: "Dock Sıfır Gecikmeli Hızlı Açılış", action: #selector(toggleDockSpeed), keyEquivalent: "")
        ...
        let motionItem = NSMenuItem(title: "Hareketi Azalt (Reduce Motion Hızlandırma)", action: #selector(toggleReduceMotion), keyEquivalent: "")
        ...
        let qlItem = NSMenuItem(title: "Quick Look Önizlemede Metin Seçimi", action: #selector(toggleQLText), keyEquivalent: "")
        qlItem.target = self
        ...
        let quarantineItem = NSMenuItem(title: "İndirilen Dosya Karantina Uyarısını Atla", action: #selector(toggleQuarantine), keyEquivalent: "")
